...
public class ItemWarpedPowerConnector extends Item {

	public ItemWarpedPowerConnector(int par1) {
		super(par1);
	...
	{
		this.iconIndex = iconRegister.registerIcon("MysticAdditions:inefficientpowerconnector");
	}

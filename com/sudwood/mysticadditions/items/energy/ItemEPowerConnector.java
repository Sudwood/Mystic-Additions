...
public class ItemEPowerConnector extends Item {

	public ItemEPowerConnector(int par1) {
		super(par1);
	...
	{
		this.iconIndex = iconRegister.registerIcon("MysticAdditions:efficientpowerconnector");
	}

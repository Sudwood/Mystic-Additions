...
public class ItemAxeSteelRC extends IItemMysticRechargeable {
	 ...
	 public ItemAxeSteelRC(int i, EnumToolMaterial enumtoolmaterial, int maxStorage, int rechargeRate)
    {
    ...
    @Override
   	...
   	{
   		this.itemIcon = iconRegister.registerIcon("MysticAdditions:steelaxerc");
   	}
    /**

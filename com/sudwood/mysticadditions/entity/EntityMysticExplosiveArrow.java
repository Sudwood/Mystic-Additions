...
public class EntityMysticExplosiveArrow extends Entity implements IProjectile
{
    ...
    public EntityMysticExplosiveArrow(World par1World)
    {
        super(par1World);
    ...
    public EntityMysticExplosiveArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public static DamageSource causeArrowDamage(EntityMysticExplosiveArrow entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if (this.inGround)
        {
        	...
        	if(!worldexplosion.isRemote)
        	{
        	
        		for(int i = 0; i<10;i++){
        	worldexplosion.createExplosion(this, this.posX, this.posY, this.posZ, 5F, true);
        		}
        	this.setDead();
        	}
        	}
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
                    ...
                    if (var4.entityHit.attackEntityFrom(damagesource, var23))
                    {
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticExplosiveArrow, 1)))
            {
                var2 = false;
            }

...
public class EntityMysticWindOrb extends Entity
{
    ...
    private int inTile;
    private int inData;
    public float spinAngleX = 0;
    public float spinAngleY = 0;
    public float spinAngleZ = 0;
    ...
    public EntityMysticWindOrb(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticWindOrb(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticWindOrb(World world, EntityLivingBase entityliving, float f)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticWindOrb(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public static DamageSource causeArrowDamage(EntityMysticWindOrb entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	//worldsetfire.createExplosion(null, posX, posY, posZ, 10F);
            	entity.motionY = 2;
            	 this.playSound("mob.enderman.scream2", 1.0F, 1.0F / (((EntityLiving) entity).getRNG().nextFloat() * 0.4F + 0.8F));
                ...
                if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.magic, 8))
                {
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && doesArrowBelongToPlayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticArrow, 1)))
        {

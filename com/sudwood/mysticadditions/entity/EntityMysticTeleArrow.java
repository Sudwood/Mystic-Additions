...
//	private String shooterName = null;
    ...
    public EntityMysticTeleArrow(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticTeleArrow(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public static DamageSource causeArrowDamage(EntityMysticTeleArrow entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if(giveBack.nextInt(2)==1){
        shooter.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticTeleArrow, 1));
        }
        	}
          ...
          //  shooter.fallDistance = 0.0F;
        		...
        		/*NBTTagCompound tag = shooter.getEntityData();
        		int[] coords = {(int)this.posX,(int)this.posY,(int)this.posZ};
        		tag.setIntArray("TeleportationArrowCoordinates", coords);
        		*/
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && doesArrowBelongToPlayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticTeleArrow, 1)))
        {

...
public class EntityMysticLightningArrow extends Entity
{
    ...
    private boolean isLightninging = true;
    private World worldOver;

    public EntityMysticLightningArrow(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticLightningArrow(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticLightningArrow(World world, EntityLivingBase entityliving, float f)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticLightningArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public static DamageSource causeArrowDamage(EntityMysticLightningArrow entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if(inGround)
        {
        	if(this.isLightninging)
        	{
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX,this.posY,this.posZ)); 
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX+1,this.posY,this.posZ));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX,this.posY,this.posZ+1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX+1,this.posY,this.posZ+1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX+1,this.posY,this.posZ-1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX-1,this.posY,this.posZ+1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX-1,this.posY,this.posZ-1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX,this.posY,this.posZ-1));
        		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, this.posX-1,this.posY,this.posZ));
        		this.isLightninging = false;
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	if(this.isLightninging)
            	{
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX,entity.posY,entity.posZ)); 
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX+1,entity.posY,entity.posZ));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX,entity.posY,entity.posZ+1));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX+1,entity.posY,entity.posZ+1));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX+1,entity.posY,entity.posZ-1));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX-1,entity.posY,entity.posZ+1));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX-1,entity.posY,entity.posZ-1));
            		worldOver.addWeatherEffect(new EntityLightningBolt(worldOver, entity.posX,entity.posY,entity.posZ-1));
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && doesArrowBelongToPlayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticLightningArrow, 1)))
        {

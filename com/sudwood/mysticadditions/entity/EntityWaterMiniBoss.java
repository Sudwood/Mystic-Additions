...
public class EntityWaterMiniBoss extends EntityMob implements IRangedAttackMob
{
    ...
    {
    	return new ItemStack(Block.waterMoving, 1);
    }
    ...
    public void func_85036_m()
    {
        ...
        if (var1 != null && var1.itemID == Block.waterMoving.blockID)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
    ...
    {
    	EntityMysticWaterOrb var2 = new EntityMysticWaterOrb(this.worldObj, this,par1EntityLiving, (float)5F, (float)12.0F);
        
        this.playSound("random.splash", 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));

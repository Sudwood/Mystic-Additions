...
public class EntityMysticFireArrow extends Entity
{
    ...
    public EntityMysticFireArrow(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticFireArrow(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticFireArrow(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public static DamageSource causeArrowDamage(EntityMysticFireArrow entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if(inGround)
        {
        	...
        	try{
        	if(!worldsetfire.isRemote){worldsetfire.setBlock((int)posX, (int)posY, (int)posZ, Block.fire.blockID,0,2);}
        	}
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && doesArrowBelongToPlayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.mysticFireArrow, 1)))
        {

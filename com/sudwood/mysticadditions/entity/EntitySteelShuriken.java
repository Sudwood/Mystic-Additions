...
public class EntitySteelShuriken extends Entity
{
    ...
    public EntitySteelShuriken(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntitySteelShuriken(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public static DamageSource causeArrowDamage(EntitySteelShuriken entityarrow, Entity entity)
    {
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && doesArrowBelongToPlayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(MysticModItems.steelShuriken, 1)))
        {

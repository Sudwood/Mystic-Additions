...
public class EntityMysticArrow extends Entity
{
    ...
    public EntityMysticArrow(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticArrow(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public static DamageSource causeArrowDamage(EntityMysticArrow entityarrow, Entity entity)
    {

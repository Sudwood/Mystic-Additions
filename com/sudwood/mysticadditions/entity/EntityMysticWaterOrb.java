...
public class EntityMysticWaterOrb extends Entity
{
    ...
    public EntityMysticWaterOrb(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticWaterOrb(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public EntityMysticWaterOrb(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public static DamageSource causeArrowDamage(EntityMysticWaterOrb entityarrow, Entity entity)
    {
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	{
            		((EntityLiving) entity).addPotionEffect(new PotionEffect(46,1200,0));
            	}
                ...
                if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.magic, 3))
                {

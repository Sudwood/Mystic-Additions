...
public class EntityWindMiniBoss extends EntityMob implements IRangedAttackMob
{
    ...
    public EntityWindMiniBoss(World par1World)
    {
        super(par1World);
        
       // this.texture = "/mods/MysticAdditions/windwizard.png";
    ...
    {
    	return new ItemStack(MysticModItems.hoeMystic, 1);
    }
    ...
    {
        return MysticModItems.cookedWarpFood.itemID;
    }
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        int var4;
            ...
            {
                this.dropItem(MysticModItems.cookedWarpFood.itemID, 1);
            }
        ...
        for (var4 = 0; var4 < var3; ++var4)
        {
            this.dropItem(MysticModItems.crudeRedstone.itemID, 3);
        }
}
    ...
    protected void dropRareDrop(int par1)
    {
            ...
            this.entityDropItem(new ItemStack(MysticModItems.hoeMystic, 800, 1), 0.0F);
    ...
    public void initCreature()
    {
          ...
          //  this.func_82162_bC();
            ...
            this.setCanPickUpLoot(this.rand.nextFloat() < 1);
    ...
    public void func_85036_m()
    {
        ...
        if (var1 != null && var1.itemID == MysticModItems.hoeMystic.itemID)
        {
            this.tasks.addTask(4, this.aiArrowAttack);
        }
    ...
    public void attackEntityWithRangedAttack(EntityLiving par1EntityLiving,float f)
    {
        ...
        EntityMysticWindOrb var2 = new EntityMysticWindOrb(this.worldObj, this,par1EntityLiving, (float)5F, (float)12.0F);
       
        this.playSound("random.breath", 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));

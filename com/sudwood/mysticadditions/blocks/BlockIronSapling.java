...
public class BlockIronSapling extends BlockFlower 
{
    protected BlockIronSapling(int i)
    {
        super(i);
        float f = 0.4F;
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("MysticAdditions:ironsapling");
    }
}

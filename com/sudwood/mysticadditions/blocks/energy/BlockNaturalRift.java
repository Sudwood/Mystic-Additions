...
public class BlockNaturalRift extends BlockContainer {
	private Random furnaceRand = new Random();
	public BlockNaturalRift(int par1, Material material) {
		super(par1, material);
	...
	public TileEntity createNewTileEntity(World var1) {
		...
		return new TileEntityNaturalRift(524288);
	}
	public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        if (true)
        {
            TileEntityNaturalRift var7 = (TileEntityNaturalRift)par1World.getBlockTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
		...
		TileEntityNaturalRift tile =(TileEntityNaturalRift) par1World.getBlockTileEntity(par2, par3, par4);
		...
		if(par5EntityPlayer.getCurrentEquippedItem()!=null&&par5EntityPlayer.getCurrentEquippedItem().itemID==MysticModItems.tPowerConnector.itemID)
		{
			...
			par5EntityPlayer.openGui(MysticAdditions.instance, 14, par1World, par2, par3, par4);
			return true;
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
      ...
      this.blockIcon = par1IconRegister.registerIcon("MysticAdditions:naturalrift");

...
public class BlockRedLog extends Block 
{
	public Icon[] iconList = new Icon[3];
    protected BlockRedLog(int i)
    {
    ...
    {
        return MysticModBlocks.redLog.blockID;
    }
            ...
            for (int i1 = -byte0; i1 <= byte0; i1++)
            {
                for (int j1 = -byte0; j1 <= byte0; j1++)
                {
                    for (int k1 = -byte0; k1 <= byte0; k1++)
                    {
                        ...
                        if (l1 != MysticModBlocks.redLeaves.blockID)
                        {
                            continue;
                        }
    ...
    {
        this.iconList[0] = par1IconRegister.registerIcon("MysticAdditions:redlogtop");
        this.iconList[1] = par1IconRegister.registerIcon("MysticAdditions:redlogside");
    }
}

...
public class BlockMysticFurnace extends BlockContainer 
{
    /**
    ...
    public Icon[] iconlist = new Icon[5];
    protected BlockMysticFurnace(int par1, boolean par2)
    {
    ...
    {
        return MysticModBlocks.mysticFurnace.blockID;
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (true)
        {
            ...
            if (var6 == 4)
            {
                ...
                par1World.spawnParticle("magicCrit", (double)(var7 - var10), (double)var8, (double)(var9 + var11), 0.0D, 0.0D, 0.0D);
            }
            else if (var6 == 5)
            {
                par1World.spawnParticle("reddust", (double)(var7 + var10), (double)var8, (double)(var9 + var11), 0.0D, 0.0D, 0.0D);
            ...
            else if (var6 == 2)
            {
                ...
                par1World.spawnParticle("magicCrit", (double)(var7 + var11), (double)var8, (double)(var9 - var10), 0.0D, 0.0D, 0.0D);
            }
            else if (var6 == 3)
            {
                par1World.spawnParticle("reddust", (double)(var7 + var11), (double)var8, (double)(var9 + var10), 0.0D, 0.0D, 0.0D);
    ...
    {
        return new TileEntityMysticFurnace();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityMysticFurnace var7 = (TileEntityMysticFurnace)par1World.getBlockTileEntity(par2, par3, par4);

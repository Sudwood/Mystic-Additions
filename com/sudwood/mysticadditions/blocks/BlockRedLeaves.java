...
public class BlockRedLeaves extends BlockLeavesBase 
{
    ...
    protected BlockRedLeaves(int i)
    {
 ...
 //   }
            ...
            for (int j1 = -l; j1 <= l; j1++)
            {
                for (int k1 = -l; k1 <= l; k1++)
                {
                    for (int l1 = -l; l1 <= l; l1++)
                    {
                        ...
                        if (i2 == MysticModBlocks.redLeaves.blockID)
                        {
                    ...
                    for (var12 = -var7; var12 <= var7; ++var12)
                    {
                        for (var13 = -var7; var13 <= var7; ++var13)
                        {
                            for (var14 = -var7; var14 <= var7; ++var14)
                            {
                                ...
                                if (var15 == MysticModBlocks.redLog.blockID)
                                {
                                    this.adjacentTreeBlocks[(var12 + var11) * var10 + (var13 + var11) * var9 + var14 + var11] = 0;
                                }
                                else if (var15 == MysticModBlocks.redLeaves.blockID)
                                {
    ...
    {
        return MysticModBlocks.redSapling.blockID;
    }
    ...
    public void harvestBlock(World par1World, EntityPlayer entityplayer, int i, int j, int k, int l)
    {
        if (!par1World.isRemote && entityplayer.getCurrentEquippedItem() != null && entityplayer.getCurrentEquippedItem().itemID == Item.shears.itemID)
        {
            ...
            dropBlockAsItem_do(par1World, i, j, k, new ItemStack(MysticModBlocks.redLeaves.blockID, 1, l & 3));
        }
        else
        {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("MysticAdditions:redleaves");
    }
}

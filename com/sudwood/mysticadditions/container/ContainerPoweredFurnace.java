...
{
    private TileEntityPoweredFurnace furnace;
    private int lastCookTime = 0;
    private int lastEnergyLevel = 0;


    public ContainerPoweredFurnace(InventoryPlayer par1InventoryPlayer, TileEntityPoweredFurnace par2TileEntityFurnace)
    {

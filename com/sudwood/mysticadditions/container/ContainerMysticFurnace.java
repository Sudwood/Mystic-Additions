...
public class ContainerMysticFurnace extends Container
{
    private TileEntityMysticFurnace furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerMysticFurnace(InventoryPlayer par1InventoryPlayer, TileEntityMysticFurnace par2TileEntityFurnace)
    {

...
public class TileEntityPoweredMysticFurnace extends TileEntityMysticEnergy implements ISidedInventory
{
	public TileEntityPoweredMysticFurnace(int maxEnergy) {
		super(maxEnergy);
		
	}
	public TileEntityPoweredMysticFurnace() {
		super(4000);
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = FurnaceRecipesMystic.smelting().getSmeltingResult(this.furnaceItemStacks[0]);

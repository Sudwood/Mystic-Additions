...
public class GuiPoweredMysticFurnace extends GuiContainer
{
    private TileEntityPoweredMysticFurnace furnaceInventory;

    public GuiPoweredMysticFurnace(InventoryPlayer par1InventoryPlayer, TileEntityPoweredMysticFurnace par2TileEntityFurnace)
    {
        super(new ContainerPoweredMysticFurnace(par1InventoryPlayer, par2TileEntityFurnace));
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("Powered Mystic Furnace"), 50, 7, 4210752);
    ...
    {
    	String var4 = "/mods/MysticAdditions/textures/mysticredgrinder.png";

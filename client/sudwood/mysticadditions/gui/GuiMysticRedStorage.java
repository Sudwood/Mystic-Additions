...
public class GuiMysticRedStorage extends GuiContainer
{
    private TileEntityMysticRedStorage furnaceInventory;

    public GuiMysticRedStorage(InventoryPlayer par1InventoryPlayer, TileEntityMysticRedStorage par2TileEntityFurnace)
    {

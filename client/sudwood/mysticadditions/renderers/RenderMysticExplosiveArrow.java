...
//            Render, EntityMysticArrow, Tessellator, MathHelper, 
//            Entity

public class RenderMysticExplosiveArrow extends Render
{

    public RenderMysticExplosiveArrow()
    {
    }

    public void renderArrow(EntityMysticExplosiveArrow entityarrow, double d, double d1, double d2, 
            float f, float f1)
    {
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        renderArrow((EntityMysticExplosiveArrow)entity, d, d1, d2, f, f1);
    }

	@Override
	protected ResourceLocation func_110775_a(Entity entity) {
		// TODO Auto-generated method stub
		return new ResourceLocation("mysticadditions","/textures/mysticexplosivearrow.png");
	}
}
